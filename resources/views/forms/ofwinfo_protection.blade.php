        ...
        <h5>FOR THE REQUESTING PARTY (Ang Kumukuha ng Record ay hindi mismong OFW)</h5>
          ...
          <div class="mb-3 mt-4">
            ...
            <div class="m-0 p-0">
              ...
              <input type="text" class="form-control disabled" name="phil_address" placeholder="Unit/Room/House Number/Street name" id="phil_address" value="{{ session('general_form_data.party_address_street') }}">
            </div>
