      ...
      <div class="form-section">
        ...
        <div class="row g-3 mb-3">
          ...
          <div class="col-md-4">
            ...
            <input type="text" class="form-control disabled" name="record_needed_mwpd_processing" id="records_needed" value="{{ $entries['record_needed_mwpd_processing'] ?? '' }}">
          </div>
          <div class="col-md-4">
            <label class="form-label">Purpose (Saan gagamitin ang kinakuhang record)</label>
            <input type="text" class="form-control disabled" name="record_purpose_mwpd_processing" id="record_purpose" value="{{ $entries['record_purpose_mwpd_processing'] ?? '' }}">
          </div>
        </div>

        <div class="mb-3">
          <label class="form-label">Name of Agency</label>
          <input type="text" class="form-control disabled" name="ofw_agency" id="ofw_agency" value="{{ $ofw->ofw_agency ?? '' }}">
        </div>
    </div>
    <div class="form-section">
      <h5>FOR THE REQUESTING PARTY (Ang Kumukuha ng Record ay hindi mismong OFW)</h5>
        <div class="row g-3 mb-3">
          <div class="col-md-4">
            <label class="form-label">Surname</label>
            <input type="text" class="form-control disabled" name="party_lname" id="req_family_name" value="{{ $party->party_lname ?? '' }}">
          </div>
          <div class="col-md-4">
            <label class="form-label">First Name</label>
            <input type="text" class="form-control disabled" name="party_fname" id="req_first_name" value="{{ $party->party_fname ?? '' }}">
          </div>
          <div class="col-md-4">
            <label class="form-label">Middle Name</label>
            <input type="text" class="form-control disabled" name="party_mname" id="req_middle_name" value="{{ $party->party_mname ?? '' }}">
          </div>
        </div>
        ...
        <div class="row g-3 mb-3">
          <div class="col-md-6">
            ...
            <input type="text" class="form-control disabled" name="party_relationship" id="relationship_ofw" value="{{ $party->party_relationship ?? '' }}">
          </div>
          <div class="col-md-6">
            <label class="form-label">Contact Number</label>
            <input type="text" class="form-control disabled" name="party_phone" id="contact_number" value="{{ $party->party_phone ?? '' }}">
          </div>
        </div>
        ...
        <div class="mb-3 mt-4">
          ...
          <div class="m-0 p-0">
            ...
            <input type="text" class="form-control mb-2 disabled" name="party_house_no" id="phil_address" value="{{ $party_address->house_no ?? '' }}">
          </div>
          ...
          <div class="row g-3">
            ...
            <div class="col-md-3">
              ...
              <input type="text" class="form-control disabled" name="party_zip_code" id="party_zip_code" value="{{ $party_address->zip_code ?? '' }}">
            </div>
          </div>
          ...
          <div class="row g-3 mt-2">
            <div class="col-md-6">
              ...
              <input type="text" class="form-control disabled" name="telephone_mwpd_processing"  id="telephone_number" value="{{ $entries['telephone_mwpd_processing'] ?? '' }}">
            </div>
            <div class="col-md-6">
              <label class="form-label">Email Address</label>
              <input type="email" class="form-control disabled" name="party_email" id="party_email" value="{{ $party->party_email ?? '' }}">
            </div>
          </div>
        </div>
    </div>
