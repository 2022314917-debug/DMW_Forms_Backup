            ...
            <p class="kasulatan-intro">
                ...
                <span class="auto-input-wrap wide">
                    ...
                    <input type="text" name="full_name_intro"
                           ...
                           value="{{ trim($ofw->ofw_fname . ' ' . $ofw->ofw_mname . ' ' . $ofw->ofw_lname . ' ' . $ofw->ofw_ename) }}"
                           readonly />
                </span>
                &nbsp;, may edad na&nbsp;
                <span class="auto-input-wrap short">
                    ...
                    <input type="text" name="edad"
                           oninput="expandInput(this)"
                           value="{{ $entries['elpor_ofw_age'] ?? null }}"
                           readonly />
                </span>
                &nbsp;, at naninirahan sa,&nbsp;
                <span class="auto-input-wrap wide">
                    ...
                    <input type="text" name="address"
                           oninput="expandInput(this)"
                           value="{{ trim($ofw_address->house_no . ' ' . $ofw_address->brgy . ', ' . $ofw_address->municipality . ', ' . $ofw_address->province . ' ' . $ofw_address->zip_code) }}"
                           readonly />
                </span>
            ...
            <p class="kasulatan-closing" style="margin-top:0;">
                ...
                <span class="auto-input-wrap">
                    ...
                    <input type="text" name="lugar_lumagda"
                           oninput="expandInput(this)"
                           value="{{ trim($ofw_address->municipality . ', ' . $ofw_address->province) }}"
                           readonly />
                </span>&#46;
            </p>
